...
const AllUsersList = (props) => {
  ...
  const isCreatedDateSelected = startDate && endDate;
  const isLastActiveSelected = lastStartDate && lastEndDate;
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-3 relative">
            ...
            <div className="relative">
              <DateRangePicker
                ...
                disabled={isCreatedDateSelected}
                defaultPreset="Today"
                panelOffsetTop={100}
                panelOffsetRight={0}
                align="right"
